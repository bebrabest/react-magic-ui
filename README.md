...
# controlled form/component usage without matching handlers (`Input`, `Select`, `Slider`, `Checkbox`, `Switch`, `Tabs`), plus Checkbox/Switch accessible-name coverage (`label`, `aria-label`, or `aria-labelledby`),
